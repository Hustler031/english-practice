...
comment on function public.english_get_review_due_today() is
  'Phase 1 read-only Review Due Today shadow summary. No live overdue scan on Home. Wrong evidence overrides same-day success; guessed/too-easy correct evidence is low-confidence. Does not alter routing or review clocks.';
