-- Follow-up fix for 20260906043000: restore the missing blank correct_option
-- expression in the new saved-item INSERT while preserving immediate one-item wake-up.
