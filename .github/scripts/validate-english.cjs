...
['function captureMyWordTyped(','My_Word_Types',"AUTO:'Auto'","CU:'Concept / Usage'",'function inferAutoMyWordType_(','function resolveMyWordType_(','function getMyWordPracticeMeta_','function getMyWordPracticeTypeMap_','function myWordTypeToNewPractice_','Grammar / Usage','Concept / Usage'].forEach(x=>need(typed,x,x));
