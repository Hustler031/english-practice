...
const required=['Code.gs','DailyV2.gs','Demand.gs','NewPractice.gs','NewPracticeLive.gs','SourcePractice.gs','TopicPractice.gs','HinduVocab.gs','DashboardStats.gs','ProgressStats.gs','Saved.gs','StarredRevision.gs','MyWordTypes.gs','StarredRevisionDetail.gs','Index.html','Styles.html','AppJS.html','QuizJS.html','FastUI.html','TopicUI.html','NewPracticeUI.html','HinduUI.html','SourceUI.html','DemandUI.html','DashboardUI.html','SavedUI.html','MyWordsFinalUI.html','StarredRevisionUI.html','AddWordTypeUI.html','StarredViewDetailUI.html','appsscript.json'];
required.forEach(f=>fs.existsSync(path.join(root,f))?ok(`File present: ${f}`):fail(`Required Apps Script file missing: ${f}`));
if(process.exitCode)process.exit(process.exitCode);
const server=['Code.gs','DailyV2.gs','Demand.gs','NewPractice.gs','NewPracticeLive.gs','SourcePractice.gs','TopicPractice.gs','HinduVocab.gs','DashboardStats.gs','ProgressStats.gs','Saved.gs','StarredRevision.gs','MyWordTypes.gs','StarredRevisionDetail.gs'];
