...
const migration=[base,integrity,quality,hardening,uiSupport,auditFix,aiInsights,speedFix].join('\n');
...
[
 ...
 [aiInsightsCss,'.ai-hub-grid','compact Insights hub'],[aiInsightsCss,'.ai-focused-item','focused question list'],[aiInsightsCss,'.ai-option-line.changed','changed-option styling'],
...
for(const [name,text] of [['base migration',base],['integrity migration',integrity],['quality migration',quality],['hardening migration',hardening],['UI support migration',uiSupport],['audit fix migration',auditFix],['AI Insights migration',aiInsights],['speed migration',speedFix]]){
