(() => {
  ...
  // Apps Script v3 supports JSONP for saveAnswer too, so a save now requires
  // one backend call instead of repeatedly reloading the entire Daily Quiz.
  function saveAnswer(data) {
    return request("saveAnswer", data);
  }
