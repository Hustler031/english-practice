...
const qs=(p:Record<string,string|number|null>)=>`/gk/teacher/quiz?${new URLSearchParams(Object.entries(p).filter(([,v])=>v!==null&&v!=="").map(([k,v])=>[k,String(v)]))}`;
