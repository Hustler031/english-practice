...
const rows = [["📝", "My Saved Words", "Manage saved words, doubts and usage points", "/english/saved"], ["★", "Starred Collection", "Your marked revision questions", "/english/starred"], ["!", "Difficult Collection", "Questions that need deliberate practice", "/english/difficult"], ["📰", "The Hindu Vocabulary", "Today's vocabulary and history", "/english/hindu?return=/english/library"], ["↗", "Phrasal Verb Bank", "Concept bank and permanent history", "/english/phrasal"], ["📚", "Source / PDF Collections", "Browse content by its source", "/english/sources?return=/english/library"], ["🎯", "Demand Set Library", "Custom sets, completion state and resume", "/english/demand"]];
