...
export default function EnglishHome() {
  const ready = useAuthGuard(); const [data, setData] = useState<Summary | null>(null); const [error, setError] = useState(""); const [paused, setPaused] = useState<PausedQuizSession | null>(null);
  useEffect(() => { if (ready) { rpc<Summary>("english_dashboard_summary").then(setData).catch((e: any) => setError(e.message)); setPaused(readPausedQuiz()); } }, [ready]);
