...
for(const marker of ["REVEAL","Reveal Answer","☆ Starred","◆ Difficult","＋ Concept","Ⅱ Pause","Jump to question","Previous","Finish"])has("Quiz",app,marker);
for(const marker of ["MOCK_QUESTIONS","MOCK_FORMULA_REVISION","MEMORY","METHOD","DRILL","Weak & Slow","Major Topics","Practice More"])has("Maths semantics",app,marker);
