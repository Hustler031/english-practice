...
for(const section of ["chapters","library","ondemand","progress","mocks","formulas","calculation","concepts","demand","new","starred","generated","session","resume"])has("Route controller",app,`section===\"${section}\"`);
